...
def rotate_boundredef(image, angle):
    ...
    ygauche = h1-ydroite
    # imagefinale.save('rotok.jpg','PNG')
...
def rotdec (nom_image,angle,x,y,taille_capteur_long,taille_capteur_hauteur):
    ...
    n = decoupe(ima, xnouv, ynouv, tcl,tch,xh,xb,yd,yg)
...
rotdec(nom,30,100,200,100,100)
#supprimer
os.remove('reechant.png')
